...
export declare class FileFieldData implements IFieldData {
    value?: FileField;
...
export declare class TextFieldData implements IFieldData {
    value?: TextField;
    extracted?: ExtractedData;
    error?: IError;
}
...
export declare class KeywordSetFieldData implements IFieldData {
...
export declare class LinkFieldData implements IFieldData {
    value?: LinkField;
...
export declare class ConversationFieldData implements IFieldData {
